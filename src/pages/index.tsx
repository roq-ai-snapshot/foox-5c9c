  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Foox - Bridging the gap between freelancers and companies. Discover your next opportunity in our thriving job marketplace."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Foox - Bridging the gap between freelancers and companies. Discover your next opportunity in our thriving job marketplace.`}
            </Text>
            <Box
